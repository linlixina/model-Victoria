#--------------------------------------------------------------
# Schematic illustration using a convex downward function PAR(v)
#--------------------------------------------------------------
library(ggplot2)
library(grid)
...
p <- ggplot() +
  ...
  coord_cartesian(xlim = c(xmin, xmax),
                  ...
                  expand = FALSE,
                  clip = "off") +
  theme(plot.margin = unit(c(5, 5, -8.5, -38), "mm"))
